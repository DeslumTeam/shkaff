...
var (
	tests = []struct {
	...
	}{
		{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 -u test -p test --authenticationDatabase=admin --ipv6 --gzip --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			name: "ipv6 disable",
			fields: fields{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 -u test -p test --authenticationDatabase=admin --gzip --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			name: "gzip disable",
			fields: fields{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 -u test -p test --authenticationDatabase=admin --ipv6 --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 -u test -p test --authenticationDatabase=admin --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			name: "Without Host",
			fields: fields{
			...
			wantRestoreString: "mongorestore --port 27018 -u test -p test --authenticationDatabase=admin --ipv6 --gzip --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			name: "Without port",
			fields: fields{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 -u test -p test --authenticationDatabase=admin --ipv6 --gzip --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			...
			wantRestoreString: "mongorestore -u test -p test --authenticationDatabase=admin --ipv6 --gzip --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 --ipv6 --gzip --nsInclude=testDB.* /opt/dump --drop -v",
		},
		{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 -u test -p test --authenticationDatabase=admin --ipv6 --gzip -d  /opt/dump/ --drop -v",
		},
		{
		...
		},
		{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 -u test -p test --authenticationDatabase=admin --ipv6 --gzip --drop -v",
		},
		{
			name: "Minumum",
			fields: fields{
		...
		},
		{
			...
			wantRestoreString: "mongorestore --host 0.0.0.0 --port 27018 --drop -v",
		},
	}
)
